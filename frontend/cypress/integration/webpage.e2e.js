...
describe('App E2E', () => {
  ...
  it('whole cycle: enter Github Repo link, select all, finish', () => {
    ...
    resizeComponents('responsive-grid-background', 71, 338, 250);
    resizeComponents('responsive-grid-background', 35, 338, 250);
    resizeComponents('responsive-grid-background', 107, 338, 250);
    ...
    /**
     * Check if Local Storage got updated with correct component data after the components got arrange on screen.
     */
